            ...
            <Container>
                <div className="space-y-6">
                    <div className="flex justify-between items-center">
                        ...
                        <Button asChild>
                            <Link href={`/organiser/events/${currentEvent?.id ?? ""}/articles/create`}>
                                        ...
                                        <TableCell>
                                            <div className="flex gap-2">
                                                <Button 
                                                    ...
                                                    size="sm"
                                                >
                                                    <Link href={`/organiser/events/${currentEvent?.id ?? ""}/articles/${article.id ?? ""}/edit`}>
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        <DropdownMenuItem asChild>
                                                            <Link href={`/attendee/events/${currentEvent?.id ?? ""}/articles/${article.id ?? ""}`}>
