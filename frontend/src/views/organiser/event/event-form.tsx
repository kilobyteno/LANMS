...
import { eventsApi, type Event as EventModel } from '@/lib/api/events';
...
export function EventForm() {
    ...
    const handleSave = async (data: FormData) => {
        ...
        try {
            let response;
            if (id) {
                response = await eventsApi.update(id, { ...eventData, id });
            } else {
                response = await eventsApi.create(eventData as EventModel);
            }
