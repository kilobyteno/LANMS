...
import { z } from "zod";
import { organisationApi, type Organisation } from '@/lib/api/organisation';
...
export function OrganisationForm() {
    ...
    const handleSave = async (data: FormData) => {
        ...
        try {
            const response = id
                ? await organisationApi.update(id, data as Organisation)
                : await organisationApi.create(data as Organisation);
